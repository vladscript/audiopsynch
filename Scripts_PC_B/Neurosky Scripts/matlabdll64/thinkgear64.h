...
/*
 * Class:     ThinkGear
 * Method:    EnableLowPassFilter
 * Signature: (IILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL
Java_ThinkGear_EnableLowPassFilter( JNIEnv *, jclass, jint, jint );

/*
 * Class:     ThinkGear
 * Method:    EnableBlinkDetection
 * Signature: (IILjava/lang/String;)I
 */
JNIEXPORT jint JNICALL
Java_ThinkGear_EnableBlinkDetection( JNIEnv *, jclass, jint, jint );
...
/*
 * Class:     ThinkGear
 * Method:    EnableAutoRead
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL
Java_ThinkGear_EnableAutoRead( JNIEnv *, jclass, jint, jint );
 ...
 */
JNIEXPORT void JNICALL
Java_ThinkGear_FreeConnection( JNIEnv *, jclass, jint );
